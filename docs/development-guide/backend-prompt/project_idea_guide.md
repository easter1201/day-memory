...
- Day Memory - 기념일 선물 추천 어플리케이션

---

### 2. 프로젝트 개요 (한 문단 요약)

- 기념일 / 이벤트 기억과 이에 따른 선물 선택에 어려움을 겪는 사용자에게 기념일 디데이 계산, 관계와 기념일에 따른 선물을 추천해주는 서비스입니다.

---

### 3. 개발 목적 및 배경

- 어떤 기념일이 있는지, 기념일마다 어떤 선물을 준비해야할지에 대해 부담을 느꼈고, 준비하려던 선물을 까먹는 불편함을 줄이기 위해 기획했습니다.
동시에 이벤트 / 스케줄링에 대한 역량을 키우기 위해 기획했습니다.
